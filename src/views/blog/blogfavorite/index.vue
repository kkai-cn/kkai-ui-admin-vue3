    ...
    >
      ...
      <el-form-item>
        ...
        <el-button
          ...
          v-hasPermi="['blog:favorite:create']"
        >
        ...
        <el-button
          ...
          v-hasPermi="['blog:favorite:export']"
        >
      ...
      <el-table-column label="操作" align="center" min-width="120px">
        <template #default="scope">
          <el-button
            ...
            v-hasPermi="['blog:favorite:update']"
          >
            编辑
          </el-button>
          <el-button
            ...
            v-hasPermi="['blog:favorite:delete']"
          >
            删除
          </el-button>
        </template>
...
<script setup lang="ts">
  import { FavoriteApi, FavoriteVO } from '@/api/blog/blogfavorite'
