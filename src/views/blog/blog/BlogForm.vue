  ...
  <Dialog :title="dialogTitle" v-model="dialogVisible">
    ...
    >
      ...
      <el-form-item label="话题id列表" prop="topicIds">
        <el-input v-model="formData.topicIds" placeholder="请输入话题id列表" />
      </el-form-item>
      ...
      <el-form-item label="背景音乐地址" prop="backgroundMusicUrl">
        <el-input v-model="formData.backgroundMusicUrl" placeholder="请输入背景音乐地址" />
      </el-form-item>
      <el-form-item label="背景音乐名称" prop="backgroundMusicName">
        <el-input v-model="formData.backgroundMusicName" placeholder="请输入背景音乐名称" />
      </el-form-item>
      <el-form-item label="声音播放模式" prop="soundMode">
        <el-select v-model="formData.soundMode" placeholder="请选择声音播放模式">
