...
import { TopicApi, TopicVO } from '@/api/blog/topic'
...
const handleExport = async () => {
  try {
    ...
    const data = await TopicApi.exportTopic(queryParams)
    download.excel(data, '主题列.xls')
  } catch {
  } finally {
